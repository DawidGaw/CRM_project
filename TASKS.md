...
- System umożliwia usunięcie klienta tylko przez użytkownika z rolą `admin`. - OK
- System przechowuje następujące dane klienta:  - OK
  - nazwa
  - email (unikalny)
  - telefon (opcjonalny)
  - firma (opcjonalna)
